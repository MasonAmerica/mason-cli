...
// logcatCmd represents the logcat command
...
func xrayLogcat(cmd *cobra.Command, args []string) {
	if len(args) < 1 {
		fmt.Println("Must provide a valid device ID")
		return
	}
	passthroughArgs := []string{"xray", args[0], "logcat"}
